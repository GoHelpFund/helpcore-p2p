...
function builder(options) {
  ...
  if (!options.network) {
    options.network = helpcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || helpcore.Block;
  options.BlockHeader = options.BlockHeader || helpcore.BlockHeader;
  options.Transaction = options.Transaction || helpcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || helpcore.MerkleBlock;
  options.MnListDiff = options.MnListDiff || helpcore.MnListDiff;
